...
import {
  $createEquationNode,
  EquationNode,
} from "@/components/kits/rich-editor/editor/nodes/equation-node";
import KatexEquationAlterer from "@/components/kits/rich-editor/editor/editor-ui/katex-equation-alterer";
