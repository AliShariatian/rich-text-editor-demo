...
import {
  ...
  LayoutContainerNode,
} from "@/components/kits/rich-editor/editor/nodes/layout-container-node";
import {
  $createLayoutItemNode,
  $isLayoutItemNode,
  LayoutItemNode,
} from "@/components/kits/rich-editor/editor/nodes/layout-item-node";
...
const LAYOUTS = [
  ...
  { label: "4 columns (equal width)", value: "1fr 1fr 1fr" },
];
