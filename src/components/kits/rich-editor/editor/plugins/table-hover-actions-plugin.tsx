  ...
  return (
    <>
      {isShownRow && (
        <button
          className={
            "EditorTheme__tableAddRows hover:bg-gray-100/80' dark:hover:bg-gray-800/80' absolute flex w-[calc(100%-25px)] cursor-pointer items-center justify-center border-0 bg-gray-100 dark:bg-gray-800"
          }
          style={{ ...position }}
      ...
      {isShownColumn && (
        <button
          className={
            "EditorTheme__tableAddColumns hover:bg-gray-100/80' dark:hover:bg-gray-800/80' absolute flex w-[calc(100%-25px)] cursor-pointer items-center justify-center border-0 bg-gray-100 dark:bg-gray-800"
          }
          style={{ ...position }}
