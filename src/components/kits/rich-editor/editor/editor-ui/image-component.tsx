...
import { $isImageNode } from "@/components/kits/rich-editor/editor/nodes/image-node";
// import brokenImage from '@/registry/default/editor/images/image-broken.svg';
import { ContentEditable } from "@/components/kits/rich-editor/editor/editor-ui/content-editable";
import { ImageResizer } from "@/components/kits/rich-editor/editor/editor-ui/image-resizer";
...
export default function ImageComponent({
  ...
  const { isCollabActive: _ } = useCollaborationContext();
          ...
          {isLoadError ? (
            ...
            <LazyImage
              className={`max-w-full cursor-default ${
                isFocused
                  ? `${$isNodeSelection(selection) ? "draggable active:cursor-grabbing' cursor-grab" : ""} focused ring-primary ring-2 ring-offset-2`
                  : null
              }`}
              src={src}
              altText={altText}
              ...
              <RichTextPlugin
                contentEditable={
                  <ContentEditable
                    ...
                    placeholderClassName="ImageNode__placeholder text-sm text-gray-500 overflow-hidden absolute top-2.5 left-2.5 pointer-events-none text-ellipsis user-select-none whitespace-nowrap inline-block dark:text-gray-400"
