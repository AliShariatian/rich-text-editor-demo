...
import { $isExcalidrawNode } from "@/components/kits/rich-editor/editor/nodes/excalidraw-node";
import ExcalidrawImage from "@/components/kits/rich-editor/editor/editor-ui/excalidraw-image";
import type { ExcalidrawInitialElements } from "@/components/kits/rich-editor/editor/editor-ui/excalidraw-modal";
import { ExcalidrawModal } from "@/components/kits/rich-editor/editor/editor-ui/excalidraw-modal";
  ...
  return (
    <>
      ...
      {elements.length > 0 && (
        <button
          ref={buttonRef}
          className={`m-0 border-0 bg-transparent p-0 ${isSelected ? "user-select-none ring-offset-2' ring-2 ring-gray-900 dark:ring-gray-50" : ""}`}
        >
          <ExcalidrawImage
