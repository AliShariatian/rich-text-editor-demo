...
import type {
  ...
  Options,
  PollNode,
} from "@/components/kits/rich-editor/editor/nodes/poll-node";
import {
  $isPollNode,
  createPollOption,
} from "@/components/kits/rich-editor/editor/nodes/poll-node";
    ...
    <div className="mb-2.5 flex flex-row items-center">
      <div
        className={`relative mr-2.5 flex h-[22px] w-[22px] rounded-md border border-gray-400 ${
          checked
            ? "border-primary after:content-[]' bg-gray-900 after:pointer-events-none after:absolute after:top-1 after:left-2 after:m-0 after:block after:h-[9px] after:w-[5px] after:rotate-45 after:cursor-pointer after:border-r-2 after:border-b-2 after:border-solid after:border-white dark:bg-gray-50"
            : ""
        }`}
      >
        <input
      ...
      <div className="relative flex flex-[10px] cursor-pointer overflow-hidden rounded-md border border-gray-200 border-gray-900 dark:border-gray-50 dark:border-gray-800">
        <div
          className="transition-width absolute top-0 left-0 z-0 h-full bg-gray-100 duration-1000 ease-in-out dark:bg-gray-800"
          style={{ width: `${votes === 0 ? 0 : (votes / totalVotes) * 100}%` }}
        />
        <span className="absolute top-1.5 right-4 text-xs text-gray-900 dark:text-gray-50">
