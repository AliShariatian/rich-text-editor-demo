...
export const placeholder = "میتونی از / استفاده کنی...";
...
export function Plugins() {
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex gap-2 overflow-auto border-b p-4">
            <BlockFormatDropDown>
              <FormatParagraph />
              <FormatHeading levels={["h2", "h3", "h4"]} />
              <FormatNumberedList />
              <FormatBulletedList />
              <FormatCheckList />
              <FormatCodeBlock />
            ...
            <div className="max-h-[30rem] overflow-y-scroll">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block min-h-96 overflow-auto px-8 py-4 focus:outline-none"
                />
              </div>
            </div>
          }
